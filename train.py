...
from trainer import trainer_rock
from icecream import ic

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='./data/Rock/Processed/train_npz', help='root dir for data')
parser.add_argument('--output', type=str, default='./output/sam/results')
parser.add_argument('--dataset', type=str,
                    default='Rock', help='dataset name')
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_Rock', help='list dir')
