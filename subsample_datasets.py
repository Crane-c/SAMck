...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/data/Rock/Processed/train_npz/')
    parser.add_argument('--output', type=str, default='/data/Rock/Processed/train_npz_lowres')
